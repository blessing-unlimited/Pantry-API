...
namespace Pantry.Api.Models.MealDb;

/// <summary>
/// Wire models for TheMealDB JSON. Filter responses contain summaries only;
/// full ingredients require lookup.php (TheMealDB, 2026).
/// </summary>
public sealed class MealDbMealsResponse
{
...
public sealed class MealDbIngredientListResponse
{
    [JsonPropertyName("meals")]
    public List<MealDbIngredientRow>? Meals { get; set; }
}

public sealed class MealDbIngredientRow
{
